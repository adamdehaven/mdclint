...
// Inlined from https://github.com/DavidAnson/markdownlint/blob/main/lib/cache.cjs
// @ts-nocheck

import { getReferenceLinkImageData as helpersGetReferenceLinkImageData } from "markdownlint/helpers";
 ...
 */
export function filterByTypesCached(types, htmlFlow = false) {
  // @ts-ignore
  return getCached(
