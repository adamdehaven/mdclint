...
import { addErrorDetailIf, isBlankLine } from "markdownlint/helpers";
import { getBlockQuotePrefixText, getHeadingLevel } from "../micromark-helpers";
import { filterByTypesCached } from "../cache";
...
const MDC022: Rule = {
  ...
  "parser": "micromark",
  "function": function MDC022(params, onError) {
